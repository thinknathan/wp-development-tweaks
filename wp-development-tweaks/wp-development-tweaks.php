...
add_action( 'wp_head', __NAMESPACE__ . '\\dev_styles' );
add_action( 'admin_head', __NAMESPACE__ . '\\dev_styles' );
...
add_action( 'wp_footer', __NAMESPACE__ . '\\dev_favicon', 100 );
add_action( 'admin_footer', __NAMESPACE__ . '\\dev_favicon', 100 );
